...
<body>
    ...
    <main>
        ...
        <?php
        // <!-- $_POST -> les paramètres ne s'affichent pas dans l'URL 
        // Pour les voir -> clique droit -> Inspecter -> Network -> clique sur la page .php et les infos sont dans Headers et Payload-->
        if (isset($_POST['lastname']) && isset($_POST['firstname'])) {
            $lastname = $_POST['lastname'];
            $firstname = $_POST['firstname']; ?>
            <p> Votre nom : <?php echo $lastname ?> </p>
            <p> Votre prénom : <?php echo $firstname ?> </p>
        <?php } else { ?>
            <p> <?php echo 'Aucun nom ou prénom n\'a été inscrit'?> </p>
        <?php }
        ?>
    </main>
