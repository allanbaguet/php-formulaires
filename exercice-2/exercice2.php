    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                ...
                Créer un formulaire demandant <strong>le nom</strong> et <strong>le prénom</strong>. Ce formulaire doit rediriger vers la page <strong>user.php</strong> avec la méthode <strong>POST</strong>.
                </p>
            </div>
        </div>
    </div>
