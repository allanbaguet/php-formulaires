        ...
        <div class="row">
            <div class="col">
                ...
                <p class="text-center fs-4">
                    Créer un formulaire demandant <strong>le nom</strong> et <strong>le prénom</strong>. Ce formulaire doit rediriger vers la page <strong>user.php</strong> avec la méthode <strong>GET</strong>.
                </p>
            </div>
        </div>
    </div>
